...
Frame::Frame(const wxString &title):wxFrame(NULL,wxID_ANY,title,wxDefaultPosition,wxSize(IMAGE_WIDTH+100,IMAGE_HEIGHT+150)/*wxSize(800,600)*/,wxMINIMIZE_BOX | wxCLOSE_BOX | wxCAPTION | wxSYSTEM_MENU)
{
   CreateUI();
...
void Frame::CreateUI()
{
   ...
   ip_ctrl = new wxTextCtrl(this,wxID_STATIC,wxT("192.168.110.48"),wxDefaultPosition,wxDefaultSize,0);
   ...
   resolution_define.Add(wxT("96x96")); // FRAMESIZE_96X96
   resolution_define.Add(wxT("QQVGA 160x120"));// FRAMESIZE_QQVGA
   resolution_define.Add(wxT("128x128")); // FRAMESIZE_128X128
   resolution_define.Add(wxT("QCIF 176x144")); // FRAMESIZE_QCIF
   resolution_define.Add(wxT("HQVGA 240x176"));// FRAMESIZE_HQVGA
   resolution_define.Add(wxT("240x240")); // FRAMESIZE_240X240
   resolution_define.Add(wxT("QVGA 320x240")); // FRAMESIZE_QVGA
   resolution_define.Add(wxT("320x320")); // FRAMESIZE_320X320
   resolution_define.Add(wxT("CIF 400x296")); // FRAMESIZE_CIF
   resolution_define.Add(wxT("HVGA 480x320")); // FRAMESIZE_HVGA
   resolution_define.Add(wxT("VGA 640x480")); // FRAMESIZE_VGA
   resolution_define.Add(wxT("SVGA 800x600")); // FRAMESIZE_SVGA
   resolution_define.Add(wxT("XGA 1024x768")); // FRAMESIZE_XGA
   resolution_define.Add(wxT("HD 1280x720")); // FRAMESIZE_HD
   resolution_define.Add(wxT("SXGA 1280x1024"));// FRAMESIZE_SXGA
   resolution_define.Add(wxT("UXGA 1600x1200"));// FRAMESIZE_UXGA
